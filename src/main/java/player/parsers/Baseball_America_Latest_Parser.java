...
public class Baseball_America_Latest_Parser extends Parser{

	private static final Logger log = LoggerFactory.getLogger(PlayerSearcher.class);

	
	public Baseball_America_Latest_Parser() {
	}

	public Baseball_America_Latest_Parser(String file, String date){
		super(file, date);
	}
