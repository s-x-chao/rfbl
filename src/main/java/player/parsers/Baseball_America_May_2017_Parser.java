...
public class Baseball_America_May_2017_Parser extends Parser{

	private static final Logger log = LoggerFactory.getLogger(PlayerSearcher.class);

	
	public Baseball_America_May_2017_Parser() {
	}

	public Baseball_America_May_2017_Parser(String file){
		super(file, "201705");
	}
