...
public class Baseball_Prospectus_2017_Parser extends Parser{

	public Baseball_Prospectus_2017_Parser() {
	}

	public Baseball_Prospectus_2017_Parser(String file){
		super(file, "201704");
	}
	...
	public void parsePlayers() {
		...
		try (Stream<String> stream = Files.lines(Paths.get(file.getAbsolutePath()))) {
			...
			for (String playerLine : lines){
				...
				String pos = playerLine.split(",")[3].trim();
